    ...
    if (empty($_POST['d_name']) || empty($_POST['about']) || $_POST['price'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "INSERT INTO dishes(title, slogan, price, img, is_special, is_regular) 
                        VALUES('" . $_POST['d_name'] . "', '" . $_POST['about'] . "', '" . $_POST['price'] . "', '" . $fnew . "', '$is_special', '$is_regular')";
                            ...
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Regular Menu</label>
                                                <input type="checkbox" name="is_regular">
                                            </div>
                                        </div>
                                    </div>
                                </div>
